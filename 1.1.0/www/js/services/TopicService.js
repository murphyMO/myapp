 ...
 * 话题服务
 */
app.factory('TopicService', ['$resource', '$window', function($resource, $window) {
	return $resource('', {}, {
//		//获取动态列表
//		getDynamicList : {
//			method : 'GET',
...
//		},
		...
		checkTopicNameValid : {
			method : 'POST',
			url : $window.platformServer + 'topic-datas/check-repeat?accesstoken=:accesstoken',
			params : {
				accesstoken : '@accesstoken'
			}
		},

		// get recomment topic list
		getRecommendTopic : {
			method : 'GET',
			url : $window.platformServer + 'topic-datas?accesstoken=:accesstoken',
			params : {
