 ...
 * 全国列表二级列表控制器 
 */
app.controller('BusinessCountryListCtrl',
	['$scope', '$rootScope', '$localStorage', 'BusinessService', '$stateParams', '$timeout', '$state','$ionicScrollDelegate', '$ionicHistory',
	function ($scope, $rootScope, $localStorage, BusinessService, $stateParams, $timeout, $state,$ionicScrollDelegate, $ionicHistory) {
		...
		// 	$state.go('findservicelist',{type_id:$scope.type_id});
		// 	}
		...
		$scope.toBusinessProduct = function(service) {
			// ui-sref="businessProduct({com_service_id:service.com_service_id,from:'countrylist'})"
			/*var data = {
