...
app.controller('XiaKeYuCtrl',
	['$scope', '$window', '$ionicHistory', '$rootScope', "$state", '$CommonFactory', '$filter', '$stateParams', 'CustomNeedService',
	function ($scope, $window, $ionicHistory, $rootScope, $state,  $CommonFactory, $filter, $stateParams, CustomNeedService) {
		...
		$scope.uploadInfoClick = function(){
			...
			CustomNeedService.uploadInfo2(data, function (response) {
