...
app.controller('PostActivityController',
	['$scope', '$rootScope', '$localStorage', '$ionicHistory','$state', '$ionicActionSheet','$cordovaCamera', '$ionicModal', 'TransferPostDataService', 'CommunityService', '$CommonFactory', 
	function ($scope, $rootScope, $localStorage, $ionicHistory, $state, $ionicActionSheet, $cordovaCamera, $ionicModal, TransferPostDataService, CommunityService, $CommonFactory ) {
