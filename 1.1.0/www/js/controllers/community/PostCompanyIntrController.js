 ...
 * 发布类型列表控制器
 */
app.controller('PostCompanyIntrCtrl',
	['$scope', '$rootScope', '$ionicHistory','$state', '$localStorage', '$ionicActionSheet','$cordovaCamera', 'TransferPostDataService', 'CommunityService', '$CommonFactory',
	function ($scope, $rootScope, $ionicHistory, $state, $localStorage, $ionicActionSheet, $cordovaCamera, TransferPostDataService, CommunityService, $CommonFactory) {
		...
		$scope.article.post_type = 'company_intr';
		/*上传图片开始*/
		...
		$scope.postCompanyIntr = function() {
			console.log($scope.article);
			var imgPath = [];
