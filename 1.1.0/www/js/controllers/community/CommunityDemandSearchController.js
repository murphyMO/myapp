 ...
 * 搜索控制器
 */
app.controller('CommunityDemandSearchCtrl',
	...
	function ($scope, CommunityService,$localStorage,$state) {
		...
		$scope.getDemandList = function(){
			$localStorage.set("demandSearchKey",$scope.demandSerchInput)
			$state.go("tab.community");
			// var data = {
			// 	"accesstoken" : accesstoken,
			// 	"currentPage" : 1,
			// 	"itemsPerPage" : 15,
			// 	"keyword" : $scope.dynamicSerchInput
			// }
			// CommunityService.getDemandList(data,function(response){
