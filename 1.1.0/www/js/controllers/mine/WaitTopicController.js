 ...
 * 2016/10/12
 */
app.controller('WaitTopicCtrl', ['$scope','$window','$state','$stateParams','$localStorage', '$resource', 'MineTopicService','$CommonFactory','$rootScope', '$ionicSlideBoxDelegate','$ionicScrollDelegate',
	...
	$scope.topicIsEmptyData = false;//默认有数据
	$scope.topicIsOverLoad = false;//默认没有加载完
