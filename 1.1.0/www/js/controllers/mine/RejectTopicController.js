 ...
 * 2016/10/12
 */
app.controller('RejectTopicCtrl', ['$scope','$window','$state','$stateParams','$localStorage', '$resource', 'MineTopicService','$CommonFactory','$rootScope', '$ionicSlideBoxDelegate','$ionicScrollDelegate',
