  ...
  function ionGallery($ionicPlatform, ionGalleryHelper, ionGalleryConfig) {
    ...
    return {
      ...
      scope: {
        ...
        ionGalleryItemEdit: '=ionGalleryItemEdit',
    ...
    function controller($scope) {
      ...
      (function () {
        $scope.$watch(function () {
          //return $scope.ionGalleryItems?$scope.ionGalleryItems.length:0;
  ...
  function ionSlider($ionicModal,ionGalleryHelper,$ionicPlatform,$timeout,$ionicScrollDelegate){
    ...
    function controller($scope,$rootScope){
      ...
      $scope.deleteImg = function(item) {
        $scope.$emit('deleteImg',item);
        // $rootScope.delete(item);
    	  $scope.ionGalleryItems.splice($scope.ionGalleryItems.indexOf(item),1);
      }
    ...
    function link(scope, element, attrs) {
      ...
      scope.loadModal = function(){
        $ionicModal.fromTemplateUrl('lib/ion-gallery-0.1.14/src/templates/slider.html', {
          scope: scope,
          animation: 'fade-in'
        }).then(function(modal) {
          _modal = modal;
